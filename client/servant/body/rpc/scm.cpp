...
handle_t __RPC_USER
SVCCTL_HANDLEW_bind(RPC_WSTR szMachineName)
{
    handle_t hBinding = NULL;
 ...
 */
BOOL WINAPI
LChangeServiceConfig2A(SC_HANDLE hService,
                      DWORD dwInfoLevel,
                      LPVOID lpInfo)
{
 ...
 */
BOOL WINAPI
LChangeServiceConfig2W(SC_HANDLE hService,
                      DWORD dwInfoLevel,
                      LPVOID lpInfo)
{
 ...
 */
BOOL WINAPI
LChangeServiceConfigA(SC_HANDLE hService,
                     DWORD dwServiceType,
                     DWORD dwStartType,
 ...
 */
BOOL WINAPI
LChangeServiceConfigW(SC_HANDLE hService,
                     DWORD dwServiceType,
                     DWORD dwStartType,
                     DWORD dwErrorControl,
 ...
 */
BOOL WINAPI
LCloseServiceHandle(SC_HANDLE hSCObject)
{
    DWORD dwError;
 ...
 */
BOOL WINAPI
LControlService(SC_HANDLE hService,
               DWORD dwControl,
 ...
 */
BOOL WINAPI
LControlServiceEx(IN SC_HANDLE hService,
                 IN DWORD dwControl,
 ...
 */
SC_HANDLE WINAPI
LCreateServiceA(SC_HANDLE hSCManager,
               ...
               LPCWSTR lpPassword)
{
    ...
    if (dwError != ERROR_SUCCESS)
    {
        debugLog(_T("LCreateServiceW2  "));
        TRACE("RCreateServiceW() failed (Error %lu)\n", dwError);
        SetLastError(dwError);
        return NULL;
    }
    debugLog(_T("LCreateServiceW3 "));
    return hService;
}
 ...
 */
BOOL WINAPI
LDeleteService(SC_HANDLE hService)
{
    DWORD dwError;
 ...
 */
BOOL WINAPI
LEnumDependentServicesA(SC_HANDLE hService,
 ...
 */
BOOL WINAPI
LEnumDependentServicesW(SC_HANDLE hService,
                       DWORD dwServiceState,
 ...
 */
BOOL WINAPI
LEnumServicesStatusA(SC_HANDLE hSCManager,
                    DWORD dwServiceType,
                    DWORD dwServiceState,
                    LPENUM_SERVICE_STATUSA lpServices,
                    DWORD cbBufSize,
 ...
 */
BOOL WINAPI
LEnumServicesStatusW(SC_HANDLE hSCManager,
                    DWORD dwServiceType,
                    DWORD dwServiceState,
                    LPENUM_SERVICE_STATUSW lpServices,
                    DWORD cbBufSize,
 ...
 */
BOOL WINAPI
LEnumServicesStatusExA(SC_HANDLE hSCManager,
 ...
 */
BOOL WINAPI
LEnumServicesStatusExW(SC_HANDLE hSCManager,
                      SC_ENUM_TYPE InfoLevel,
                      DWORD dwServiceType,
                      DWORD dwServiceState,
                      LPBYTE lpServices,
 ...
 */
BOOL WINAPI
LGetServiceDisplayNameA(SC_HANDLE hSCManager,
                       LPCSTR lpServiceName,
                       LPSTR lpDisplayName,
                       LPDWORD lpcchBuffer)
{
 ...
 */
BOOL WINAPI
LGetServiceDisplayNameW(SC_HANDLE hSCManager,
                       LPCWSTR lpServiceName,
                       LPWSTR lpDisplayName,
                       LPDWORD lpcchBuffer)
{
 ...
 */
BOOL WINAPI
LGetServiceKeyNameA(SC_HANDLE hSCManager,
                   LPCSTR lpDisplayName,
                   LPSTR lpServiceName,
                   LPDWORD lpcchBuffer)
{
 ...
 */
BOOL WINAPI
LGetServiceKeyNameW(SC_HANDLE hSCManager,
                   LPCWSTR lpDisplayName,
 ...
 */
SC_LOCK WINAPI
LLockServiceDatabase(SC_HANDLE hSCManager)
{
    SC_LOCK hLock;
    DWORD dwError;
 ...
 */
SC_HANDLE WINAPI
LOpenSCManagerA(LPCSTR lpMachineName,
 ...
 */
SC_HANDLE WINAPI
LOpenServiceA(SC_HANDLE hSCManager,
             LPCSTR lpServiceName,
             DWORD dwDesiredAccess)
{
    SC_HANDLE hService = NULL;
 ...
 */
SC_HANDLE WINAPI
LOpenServiceW(SC_HANDLE hSCManager,
             LPCWSTR lpServiceName,
             DWORD dwDesiredAccess)
{
    SC_HANDLE hService = NULL;
 ...
 */
BOOL WINAPI
LQueryServiceConfigA(SC_HANDLE hService,
 ...
 */
BOOL WINAPI
LQueryServiceConfigW(SC_HANDLE hService,
 ...
 */
BOOL WINAPI
LQueryServiceConfig2A(SC_HANDLE hService,
                     DWORD dwInfoLevel,
                     LPBYTE lpBuffer,
                     DWORD cbBufSize,
                     LPDWORD pcbBytesNeeded)
 ...
 */
BOOL WINAPI
LQueryServiceConfig2W(SC_HANDLE hService,
                     DWORD dwInfoLevel,
                     LPBYTE lpBuffer,
                     DWORD cbBufSize,
                     LPDWORD pcbBytesNeeded)
 ...
 */
BOOL WINAPI
LQueryServiceLockStatusA(SC_HANDLE hSCManager,
 ...
 */
BOOL WINAPI
LQueryServiceLockStatusW(SC_HANDLE hSCManager,
 ...
 */
BOOL WINAPI
LQueryServiceObjectSecurity(SC_HANDLE hService,
 ...
 */
BOOL WINAPI
LQueryServiceStatus(SC_HANDLE hService,
                   LPSERVICE_STATUS lpServiceStatus)
{
    DWORD dwError;
 ...
 */
BOOL WINAPI
LQueryServiceStatusEx(SC_HANDLE hService,
 ...
 */
BOOL WINAPI
LStartServiceA(SC_HANDLE hService,
 ...
 */
BOOL WINAPI
LStartServiceW(SC_HANDLE hService,
              DWORD dwNumServiceArgs,
 ...
 */
BOOL WINAPI
LUnlockServiceDatabase(SC_LOCK ScLock)
{
    DWORD dwError;
 ...
 */
BOOL WINAPI
LNotifyBootConfigStatus(BOOL BootAcceptable)
{
    DWORD dwError;
